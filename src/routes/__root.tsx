...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", sizes: "180x180", href: "/apple-touch-icon.png?v=336" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon-180x180.png?v=336" },
      { rel: "apple-touch-icon-precomposed", href: "/apple-touch-icon-precomposed.png?v=336" },
      {
        rel: "preconnect",
