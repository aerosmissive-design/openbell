...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", sizes: "180x180", href: "/openbell-touch-180.png" },
      { rel: "apple-touch-icon", href: "/openbell-touch-180.png" },
      { rel: "apple-touch-icon-precomposed", href: "/openbell-touch-180.png" },
